...
6. Нажмите на **Anonymous**
7. Включите переключатель **Enable**
8. Нажмите **Save**

**Важно:** Anonymous Authentication должен быть включен, иначе регистрация и вход не будут работать!

**Примечание:** Система использует логин и пароль (email не обязателен). Пароли хранятся в зашифрованном виде в Firestore.
