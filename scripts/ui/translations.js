...
window.translations = {
    ru: {
        ...
        mp2Players: '2 игрока',
        mpVsBot: 'Против бота',
        mpVsBotDesc: 'ИИ-соперник, каждый раз новый текст и темп',
        mpBotRoomTitle: 'Дуэль с ботом',
        mpStartBotBattle: 'Начать',
        mpBotOpponent: 'Бот',
        mpBotVoice: 'Голос (озвучка в браузере)',
        mpBotVoiceHint: 'Короткие реплики через синтез речи; можно выключить.',
    ...
    en: {
        ...
        mpVsBot: 'Vs bot',
        mpVsBotDesc: 'AI opponent, fresh text every match',
        mpBotRoomTitle: 'Duel vs bot',
        mpStartBotBattle: 'Start',
        mpBotOpponent: 'Bot',
        mpBotVoice: 'Voice (browser TTS)',
        mpBotVoiceHint: 'Short lines via speech synthesis; you can turn it off.',
        mpVsBotHud: 'Vs bot',
        mpBotSays: 'chat',
    ...
    ua: {
        ...
        mp2Players: '2 гравці',
        mpVsBot: 'Проти бота',
        mpVsBotDesc: 'Суперник-ІІ, щоразу новий текст і темп',
        mpBotRoomTitle: 'Дуель із ботом',
        mpStartBotBattle: 'Почати',
        mpBotOpponent: 'Бот',
        mpBotVoice: 'Голос (озвучка в браузері)',
        mpBotVoiceHint: 'Короткі репліки через синтез мови; можна вимкнути.',
